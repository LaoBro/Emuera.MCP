...
/// </summary>
/// <remarks>
/// 编译期 <c>#if</c> 分流：Windows 编译返回 <see cref="WindowsJsBridge"/>，Android 编译返回 <see cref="AndroidJsBridge"/>。
...
internal static class JsBridgeFactory
{
	...
	/// </summary>
	/// <returns>Windows 下返回 <see cref="WindowsJsBridge"/>，Android 下返回 <see cref="AndroidJsBridge"/>。</returns>
