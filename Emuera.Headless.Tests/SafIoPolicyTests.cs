...
public class SafIoPolicyTests
{
    ...
    private static readonly IReadOnlyDictionary<string, int> KnownDirectIoCallSites =
        new Dictionary<string, int>(StringComparer.Ordinal)
        {
            ...
            ["Config/ConfigData.cs:1146"] = 1,
            ["Config/JSON/JSONConfig.cs:18"] = 1,
            ["Config/JSON/JSONConfig.cs:20"] = 1,
            ["Config/JSON/JSONConfig.cs:24"] = 1,
            ["Config/JSON/JSONConfig.cs:28"] = 1,
            ["Config/JSON/JSONConfig.cs:32"] = 1,
            ["Config/JSON/JSONConfig.cs:34"] = 1,
            ["Config/JSON/JSONConfig.cs:46"] = 1,
