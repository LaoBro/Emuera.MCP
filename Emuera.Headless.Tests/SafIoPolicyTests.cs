...
public class SafIoPolicyTests
{
    ...
    private static readonly IReadOnlyDictionary<string, int> KnownDirectIoCallSites =
        ...
        {
            ["Config/ConfigData.cs:877"] = 1,
            ["Config/ConfigData.cs:924"] = 1,
            ["Config/ConfigData.cs:925"] = 1,
            ["Config/ConfigData.cs:929"] = 1,
            ["Config/ConfigData.cs:932"] = 1,
            ["Config/ConfigData.cs:989"] = 1,
            ["Config/ConfigData.cs:996"] = 1,
            ["Config/ConfigData.cs:997"] = 1,
            ["Config/ConfigData.cs:1003"] = 1,
            ["Config/ConfigData.cs:1010"] = 1,
            ["Config/ConfigData.cs:1011"] = 1,
            ["Config/ConfigData.cs:1012"] = 1,
            ["Config/ConfigData.cs:1014"] = 1,
